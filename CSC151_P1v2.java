...
public class CSC151_P1v2 {
    public static void main(String[] args) {
        ...
        /*
         * Ask user to enter their hometown (city and state) in one variable ii. Print
         * the hometown in ALL UPPERCASE iii. Print the hometown in all lowercase iv.
         * Print the last character of hometown in UPPERCASE
         */
        ...
        /*
         * Calculate 4 results – make sure to use appropriate expression and Math
         * function when appropriate.
         * 
         * result1 = a 7 + 5 * 9 (result1 must be integer) result2 = a 4 - 8ab + b 5
         * (result2 must be integer) result3 = ((2a − 5)/18) + ((3b - 7)/15) (make sure
         * that you get decimal points) result4 = (5r^10 + 3)/9 (make sure that you get
         * decimal points)
         */
        ...
        System.out.println("\n\tUpper Case ==> " + hometown.toUpperCase() + "\n\tLower Case ==> "
                + hometown.toLowerCase() + "\n\tLast character ==> " + hometown.charAt(0));

        System.out.println("Program 1 is completed by " + name);

        /*
         * SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy HH:mm"); Date
         * date = new Date();
         * 
