    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        do
        {
            ...
            System.out.println("What ice cream flavor would you like? (Enter the flavor name or a number 1-6) ");
            ...
            switch(flavor)
            {
                ...
                break;
                case "Blackberry", "4":
                System.out.println("You chose Blackberry");
                scoopCost = 1.50F;
                break;
                case "Oreo", "5":
                System.out.println("You chose Oreo");
                scoopCost = 1.75F;
                break;
                case "Rocky Road", "6":
                System.out.println("You chose Rocky Road");
                scoopCost = 1.99F;
                break;
            }
            ...
            System.out.println("Your order of  " + flavor + " for " + noScoops + " scoops costs $" + decimalFormat.format(totalCost) + ".");
