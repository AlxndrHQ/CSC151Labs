...
- [TODO] a. You will create exact duplicate of you MMM_myUnsortedIntegers 3 times, but name them MMM_mySortedIntegers1, MMM_mySortedIntegers2, MMM_mySortedIntegers3 [Note that after your copy, all 3 arrays will have unsorted data, but the other 3 arrays will be used in sorting algorithm below]
