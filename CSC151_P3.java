...
public class CSC151_P3 {
    public static void main(String[] args) {
        // Write an ice-cream store application that asks the customer a flavor of
        // ice-cream (each has a different price),
        // ask how many scoops,
        ...
        float scoopCost = 0.0F;// = a floating-point representing a cost of ice-cream per scoop, based on
                               // ice-cream flavor
        ...
        totalCost = scoopCost * noScoops;// = a floating-point representing a total cost of ice-cream, i.e., aCost *
                                         // noScoop
        // prints what the total cost is based on flavor and number of scoops
        System.out.println("\nYour order of  " + flavor + " for " + noScoops + " scoops costs $"
        ...
        System.out.println("\nWith your change, you can get " + decimalFormat.format(remainingScoops)
