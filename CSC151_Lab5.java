...
public class CSC151_Lab5 {
    public static void main(String[] args) {
        ...
        System.out.println("\nYour name is " + name + ", your age is " + age + ", your GPA is " + gpa
                + ", your major is " + major + ", you are taking " + noClasses + " classes");
        ...
        total = (cost + tax);
        System.out.println(
                "\nTotal is " + total + " Cost is " + cost + ", the rate is " + rate + " and the tax is " + tax);
        ...
        System.out.println("\nYour loan amount was " + loanAmount + ". \nAs a result, you will pay $" + result2
