...
public class WilliamsJrS_Lab4
{
  public static void main(String[] args)
  {
      ...
      System.out.println("The grade for chemistry is " + chemistryGrade + ", the grade for physics is " + physicsGrade + ", the grade for calculus is " + calculusGrade + ", the grade for history is " + historyGrade + ", and the GPA for the semester is " + GPA );
      ...
      System.out.println("The second string is " + secondString + ". Second String's length is " + secondString.length());
      System.out.println("The second string is " + secondString + ". Second String's first character is " + secondString.charAt(0));
