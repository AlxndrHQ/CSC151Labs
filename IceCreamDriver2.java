...
public class IceCreamDriver2 {
    public static void main(String[] args) {
        ...
        do {
            ...
            while (!(bill == 1 || bill == 5 || bill == 10 || bill == 20)) {// used as long as the bill is not a 1, 5, 10,
                                                                           // or
                                                                           // 20
            ...
            double userTender = 0.0;
            while ((bill == 1 || bill == 5 || bill == 10 || bill == 20)) {
                userTender = (double) bill;
                System.out.println("You have " + userTender + " on your books.");

                while ((userTender - totalCost) < 0.0) {
                    double remaining = totalCost - (double) bill;
                    System.out.println("Please enter " + remaining + " to complete your order");
                    userTender += keyboard.nextInt();

                    do
                    {
                        System.out.println("Please enter your bill ($1, $5, $10, $20)");
                        userTender += keyboard.nextInt();
                    } while (!(bill == 1 || bill == 5 || bill == 10 || bill == 20)); // used as long as the bill is not a
                                                                                   // 1, 5, 10,
                                                                                   // or
                                                                                   // 20
                }
            ...
            change = (float)userTender - totalCost;// = a floating-point representing a change after paying for this ice-cream cone
            ...
            System.out.println("With your change, you can get " + decimalFormat.format(remainingScoops)
                    + " more scoops of " + flavor);

            /*
             * To Do: - needs to create object for this order - Needs to add order object to
             * stack - needs to print order object from stack
             */
