...
* File Name: sortNsearch.java
* Purpose: does the sorting and searching for the driver
================================================================== */
...
public class SortAndSearch {
    ...
    public static int IntSequentialSearch(int[] array, int value) {
        /*
         * this is a sequential search method with 2 parameters (integer array and
    ...
    public static void IntSelectionSort(int[] array) {
        /*
         * this is a selection sort method with 1 parameter (integer array to be
         * sorted), no return value, but the array that you pass to this method will be
         * sorted.
         */
    ...
    public static void IntInsertionSort(int[] array) {
        /*
         * this is a insertion sort method with 1 parameter (integer array to be
         * sorted), no return value, but the array that you pass to this method will be
         * sorted.
         */
